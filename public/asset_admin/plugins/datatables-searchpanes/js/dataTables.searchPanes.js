...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
        ...
        /**
         * Adjusts the inc of the top row when the screen is resized
         */
        ...
        /**
         * Resizes the pane based on the inc that is passed in
         *
         * @param layout the inc to be applied to this pane
         */
    ...
    var SearchPanes = /** @class */ (function () {
        ...
        SearchPanes.prototype.resizePanes = function () {
            if (this.c.layout === 'auto') {
                ...
                for (var _b = 0, _c = this.s.panes; _b < _c.length; _b++) {
                    var pane = _c[_b];
                    // Resize the pane with the new inc
                    if (pane.s.displayed) {
        ...
        SearchPanes.prototype._startup = function (table) {
            ...
            // If the inc is set to auto then the panes need to be resized to their best fit
            if (this.c.layout === 'auto') {
                this.resizePanes();
            }
